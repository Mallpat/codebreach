...
export function HandoffScreen({ incidentReport, timer, challengeTitle, onSkip }) {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 animate-in fade-in zoom-in-95 duration-400">
      <div className="glass-panel-rose rounded-3xl p-8 shadow-2xl relative overflow-hidden">
        {/* Urgent header strip */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-rose-500/30 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-xs font-mono px-2.5 py-0.5 rounded-full bg-rose-500/20 text-rose-300 font-bold border border-rose-500/30">
          ...
          <div className="flex items-center gap-3 self-end sm:self-center">
            ...
            {onSkip && (
              <button
                ...
                className="px-4 py-2 rounded-xl glass-card-interactive text-xs font-mono text-slate-200 cursor-pointer flex items-center gap-1.5 transition-all hover:text-white"
              >
                <span>Jump In</span>
        ...
        <div className="space-y-4 font-mono text-xs sm:text-sm text-slate-300 glass-panel rounded-2xl p-6 leading-relaxed whitespace-pre-line max-h-[50vh] overflow-y-auto">
          <div className="flex items-center gap-2 text-cyan-400 pb-2 border-b border-white/10 font-bold text-xs uppercase tracking-wider">
