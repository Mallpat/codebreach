...
export function TestPanel({ testResults = [], isTesting, onRunTests }) {
  ...
  return (
    <div className="flex flex-col h-full glass-panel border-t lg:border-t-0 lg:border-l border-white/10 text-xs font-mono">
      {/* Header */}
      <div className="p-3 border-b border-white/10 bg-[#0d101a]/70 backdrop-blur-md flex items-center justify-between gap-3 shrink-0">
