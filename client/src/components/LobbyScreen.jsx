...
import { Shield, Bug, Users, Play, Copy, Check, Terminal, Clock, Sparkles, AlertCircle } from 'lucide-react';
            ...
            <div className="space-y-3">
              ...
              {players.length === 1 && (
                <p className="text-center text-xs text-amber-400/90 font-mono flex items-center justify-center gap-1.5">
                  ...
                  Solo Sandbox Mode enabled. Open another tab or invite a friend to play multiplayer!
                </p>
              )}
            </div>
          </div>
          ...
          <div className="glass-panel rounded-2xl p-5 border border-slate-800/80">
            <div className="flex items-center justify-between mb-4 pb-2 border-b border-slate-800">
              <h3 className="font-heading font-bold text-white flex items-center gap-2 text-base">
                <Users className="w-4 h-4 text-cyan-400" /> Engineering Squad ({players.length})
              </h3>
